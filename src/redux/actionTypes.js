...
export const ADD_IGTV = "ADD_IGTV";
...
export const DELETE_TAGGED = "DELETE_TAGGED";
...
export const TOGGLE_EXPLORE_VIEW = "TOGGLE_EXPLORE_VIEW";
...
export const ADD_LIKE_EXPLORE = "ADD_LIKE_EXPLORE";
export const DELETE_LIKE_EXPLORE = "DELETE_LIKE_EXPLORE";
export const ADD_SAVED_EXPLORE = "ADD_SAVED_EXPLORE";
export const DELETE_SAVED_EXPLORE = "DELETE_SAVED_EXPLORE";
